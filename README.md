...
> **129 skills indexed.** Physically organised into 16 top-level group directories. Signature Automatos agents (SENTINEL, SCOUT, HARPER, ECHO, ATLAS, FORGE, ORACLE, RALLY, PATCHER, AUTOMATOS-DEV) live under [`team/`](./team/).
...
| Domain | Dir | Count |
|---|---|---|
| [The Automatos Team](#the-automatos-team) — signature named agents | [`team/`](./team/) | 10 |
